...
<head>
  ...
  <script type="text/javascript">
            function validation() {
                var name = document.question10.ans10.value;
                if (name == null || name == "") {
...
// Check connection
 ...
 <center>
        ...
        <div class="container p-0 my-3">
            <form action="questn10_connect.php" method="POST" name="question10" id="question10" onsubmit="return validation()">
  <hr class="container" style="height:10px;border-width:0;color: red;background-color: red">
                <h3 style="color: black; font-family: cursive; font-weight: bold">10th</h3>
                <label name="q10" id="q10" style="color: white; font-size: larger">  Is there a secret you want to tell <?php echo "" . $row["user_name"] . ""; ?>?</label>
<?php
        }
        ?>
  <textarea class="form-control" rows="5" id="ans10" name="ans10" placeholder="Enter your honest answer here"></textarea>
<br>
