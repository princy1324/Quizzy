...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function validation() {
                var name = document.question2.ans2.value;
                if (name == null || name == "") {
...
// Check connection
        ...
        <div class="container p-0 my-3">
            <form action="questn2_connect.php" method="POST" name="question2" id="question2" onsubmit="return validation()">
                <hr class="container" style="height:10px;border-width:0;color: red;background-color: red">
                <h3 style="color: black; font-family: cursive; font-weight: bold">2nd</h3>
                <label type="text" name="q2" id="q2"class="form-control" style="color: white; font-size: larger"> What is your relation with <?php echo "" . $row["user_name"] . "?"; ?> </label>
                <?php
            }
            ?>
            <textarea class="form-control" rows="5" id="ans2" name="ans2" placeholder="Enter your honest answer here"></textarea>
            <br>
