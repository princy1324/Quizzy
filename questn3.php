...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function validation() {
                var name = document.question3.ans3.value;
                if (name == null || name == "") {
...
// Check connection
        ...
        <div class="container p-0 my-3 ">
            <form action="questn3_connect.php" method="POST" name="question3" id="question3" onsubmit="return validation()">
                <hr class="container" style="height:10px;border-width:0; background-color: #0a094f">
                <h3 style="color: black; font-family: cursive; font-weight: bold">3rd</h3>
                <label type="text" name="q3"class="form-control" id="q3" style="color: #ffffff; font-size: larger"> Your favorite memory with <?php echo "" . $row["user_name"] . "?"; ?> </label>
                <?php
            }
            ?>

            <textarea class="form-control" rows="5" id="ans3" name="ans3" placeholder="Enter your honest answer here"></textarea>
            <br>
