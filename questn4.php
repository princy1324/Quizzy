...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function validation() {
                var name = document.question4.ans4.value;
                if (name == null || name == "") {
...
// Check connection
        ...
        <div class="container p-0 my-3">
            <form action="questn4_connect.php" method="POST" name="question4" id="question4" onsubmit="return validation()">
                <hr class="container" style="height:10px;border-width:0;color: red;background-color: red">
                <h3 style="color: black; font-family: cursive; font-weight: bold">4th</h3>
                <p  name="q4" id="q4" style="color: white; font-size: larger" >If you could add one thing in <?php echo "" . $row["user_name"] . "'s"; ?> life, what would it be? </p>
                <?php
            }
            ?>
            <textarea class="form-control" rows="5" id="ans4" name="ans4" placeholder="Enter your honest answer here"></textarea>
            <br>
