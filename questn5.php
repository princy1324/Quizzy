...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function validation() {
                var name = document.question5.ans5.value;
                if (name == null || name == "") {
...
// Check connection
        ...
        <div class="container p-0 my-3 ">
            <form action="questn5_connect.php" method="POST" name="question5" id="question5" onsubmit="return validation()">
          <hr class="container" style="height:10px;border-width:0; background-color: #0a094f">
                <h3 style="color: black; font-family: cursive; font-weight: bold">5th</h3>
                <label type="text" name="q5" id="q5" style="color: #ffffff; font-size: larger">From when you know Childhood,School or college <?php echo "" . $row["user_name"] . ""; ?> do you like the most? </label>
           <?php
        }
        ?>
            <textarea class="form-control" rows="5" id="ans5" name="ans5" placeholder="Enter your honest answer here"></textarea>
            <br>
            <br>
