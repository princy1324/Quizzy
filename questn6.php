...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
   <script type="text/javascript">
            function validation() {
                var name = document.question6.ans6.value;
                if (name == null || name == "") {
...
// Check connection
      ...
      <center>
        ...
        <div class="container p-0 my-3">
            <form action="questn6_connect.php" method="POST" name="question6" id="question6" onsubmit="return validation()">
   <hr class="container" style="height:10px;border-width:0;color: red;background-color: red">
                <h3 style="color: black; font-family: cursive; font-weight: bold">6th</h3>
                <label type="text" name="q6" id="q6"style="color: white; font-size: larger">According to you, which color suits <?php echo "" . $row["user_name"] . ""; ?> ?</label>
  
  <?php
        }
        ?>
  <textarea class="form-control" rows="5" id="ans6" name="ans6" placeholder="Enter your honest answer here"></textarea>
<br>
<center><button type="submit" class="btn btn-danger btn-lg">Continue</button></center></form>
<br>
</div>
</body>
</html>