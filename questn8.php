...
<head>
  ...
  <script type="text/javascript">
            function validation() {
                var name = document.question8.ans8.value;
                if (name == null || name == "") {
...
// Check connection
      ...
      <center>
        ...
        <div class="container p-0 my-3">
            <form action="questn8_connect.php" method="POST" name="question8" id="question8" onsubmit="return validation()">
  <hr class="container" style="height:10px;border-width:0;color: red;background-color: red">
                <h3 style="color: black; font-family: cursive; font-weight: bold">8th</h3>
                <label name="q8" id="q8" class="form-control" style="color: white; font-size: larger" > Where do you mostly talk with <?php echo "" . $row["user_name"] . ""; ?> SocialMedia or in Collegue?</label>
  <?php
        }
        ?>
  <textarea class="form-control" rows="5" id="ans8" name="ans8" placeholder="Enter your honest answer here"></textarea>
<br>
<center><button type="submit" class="btn btn-danger btn-lg">Continue</button></center>
</form>
<br>
</div>
</body>
