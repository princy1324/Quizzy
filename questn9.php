...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
   <script type="text/javascript">
            function validation() {
                var name = document.question9.ans9.value;
                if (name == null || name == "") {
...
// Check connection
    ...
    <center>
        ...
        <div class="container p-0 my-3 ">
            <form action="questn9_connect.php" method="POST" name="question9" id="question9" onsubmit="return validation()">
   <hr class="container" style="height:10px;border-width:0; background-color: #0a094f">
                <h3 style="color: black; font-family: cursive; font-weight: bold">9th</h3>
                <label type="text" name="q9" id="q9" style="color: #ffffff; font-size: larger" >If <?php echo "" . $row["user_name"] . ""; ?> was an animal, what animal would you suggest?</label>
  <?php
        }
        ?>
  <textarea class="form-control" rows="5" id="ans9" name="ans9" placeholder="Enter your honest answer here"></textarea>
<br>
